...
class SubPlayerJS {
    ...
    constructor(div, file) {
        ...
        // if (!$("link[href='https://rawgit.com/EldinZenderink/SubPlayerJS/master/SubPlayerJS1.css']").length) {
        //     alert("error");
	...
	videoend() {
        //var videoid = this.videoid.toString();
		document.getElementById('SubPlayerVideo_' + videoid.toString()).addEventListener('ended',myHandler,false);
